...
dd = dadi.Misc.make_data_dict('dadi_input_JLA_JED.tsv')
...
# of the fs.
data = dadi.Spectrum.from_data_dict(dd, ['JLA','JED'], [129,92],
                                      polarized=False)
...
upper_bound = [100, 100, 100, 100, 20, 20, 12, 12]
lower_bound = [0.01, 0.01, 0.01, 0.01, 0, 0, 0, 0]

# This is our initial guess for the parameters, which is somewhat arbitrary.
params = ('nu1a', 'nu2a', 'nu1', 'nu2', 'm12', 'm21', 'Ts', 'Te')   
p0 = [0.1, 0.1, 1, 1, 1, 1, 1, 1]
